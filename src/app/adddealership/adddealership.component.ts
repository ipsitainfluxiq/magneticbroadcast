...
@Component({
  selector: 'app-adddealership',
  templateUrl: './adddealership.component.html',
  styleUrls: ['./adddealership.component.css'],
...
export class AdddealershipComponent implements OnInit {
  ...
  constructor(fb: FormBuilder, private _http: Http, private router: Router, private _commonservices: Commonservices) {
    ...
    AdddealershipComponent.blankemail = false;
    AdddealershipComponent.invalidemail = false;
  }
  ...
  static validateEmail(control: FormControl) {
    ...
    if (control.value == '') {
      AdddealershipComponent.blankemail = true;
      return {'invalidemail': true};
    }
    if (!control.value.match(/[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\.[a-z0-9!#$%&'*+/=?^_`{|}~-]+)*@(?:[a-z0-9](?:[a-z0-9-]*[a-z0-9])?\.)+[a-z0-9](?:[a-z0-9-]*[a-z0-9])?/)) {
      AdddealershipComponent.invalidemail = true;
      return {'invalidemail': true};
    }
  }
  ...
  //  console.log('t ' + type);
    if (type == 'invalid') {
      return AdddealershipComponent.invalidemail;
    }
    if (type == 'blank') {
      return AdddealershipComponent.blankemail;
    }
  }
  ...
  dosubmit(formval) {
    ...
    if (this.dataForm.valid && this.passmatchvalidate && (AdddealershipComponent.invalidemail == false || AdddealershipComponent.blankemail == false)) {
